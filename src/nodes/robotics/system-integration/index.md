---
{
  ...
  "relations": [{ "target": "embedded.drivers", "type": "required" }, { "target": "communication.protocol-framing", "type": "required" }, { "target": "control.pid", "type": "required" }, { "target": "robotics.bring-up", "type": "recommended" }],
  "parts": []
}
---
